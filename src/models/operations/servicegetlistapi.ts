...
export type ServiceGetListApiResponse = {
   ...
   * @remarks
   */
  services?: Array<models.Service> | undefined;
};
...
> = z.object({
  ...
  services: z.array(models.Service$inboundSchema).optional(),
});
...
export type ServiceGetListApiResponse$Outbound = {
  ...
  totalCount?: number | undefined;
  services?: Array<models.Service$Outbound> | undefined;
};
...
> = z.object({
  ...
  totalCount: z.number().int().optional(),
  services: z.array(models.Service$outboundSchema).optional(),
});
