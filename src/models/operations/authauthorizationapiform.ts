...
export type AuthAuthorizationApiFormRequest = {
  ...
  apilBraceserviceIdRBraceAuthAuthorization:
    models.APILBraceserviceIdRBraceAuthAuthorization;
};
...
> = z.object({
  serviceId: z.string(),
  APILBraceserviceIdRBraceAuthAuthorization:
    models.APILBraceserviceIdRBraceAuthAuthorization$inboundSchema,
}).transform((v) => {
  return remap$(v, {
    "APILBraceserviceIdRBraceAuthAuthorization":
      "apilBraceserviceIdRBraceAuthAuthorization",
...
export type AuthAuthorizationApiFormRequest$Outbound = {
  serviceId: string;
  APILBraceserviceIdRBraceAuthAuthorization:
    models.APILBraceserviceIdRBraceAuthAuthorization$Outbound;
};
...
> = z.object({
  serviceId: z.string(),
  apilBraceserviceIdRBraceAuthAuthorization:
    models.APILBraceserviceIdRBraceAuthAuthorization$outboundSchema,
}).transform((v) => {
  return remap$(v, {
    apilBraceserviceIdRBraceAuthAuthorization:
      "APILBraceserviceIdRBraceAuthAuthorization",
