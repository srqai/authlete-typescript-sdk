...
/**
 * An object containing api_serviceid_auth_token_create data
 */
export type ApiServiceIdAuthTokenCreate = {
  /**
...
/** @internal */
export const ApiServiceIdAuthTokenCreate$inboundSchema: z.ZodType<
...
/** @internal */
export type ApiServiceIdAuthTokenCreate$Outbound = {
  grantType: string;
  clientId: number;
  subject?: string | undefined;
  scopes?: Array<string> | undefined;
...
/** @internal */
export const ApiServiceIdAuthTokenCreate$outboundSchema: z.ZodType<
  ApiServiceIdAuthTokenCreate$Outbound,
  z.ZodTypeDef,
  ApiServiceIdAuthTokenCreate
> = z.object({
 ...
 */
export namespace ApiServiceIdAuthTokenCreate$ {
  /** @deprecated use `ApiServiceIdAuthTokenCreate$inboundSchema` instead. */
  export const inboundSchema = ApiServiceIdAuthTokenCreate$inboundSchema;
  /** @deprecated use `ApiServiceIdAuthTokenCreate$outboundSchema` instead. */
  export const outboundSchema = ApiServiceIdAuthTokenCreate$outboundSchema;
  /** @deprecated use `ApiServiceIdAuthTokenCreate$Outbound` instead. */
  export type Outbound = ApiServiceIdAuthTokenCreate$Outbound;
}

export function apiServiceIdAuthTokenCreateToJSON(
  apiServiceIdAuthTokenCreate: ApiServiceIdAuthTokenCreate,
): string {
  return JSON.stringify(
    ApiServiceIdAuthTokenCreate$outboundSchema.parse(
      apiServiceIdAuthTokenCreate,
    ),
  );
}

export function apiServiceIdAuthTokenCreateFromJSON(
  jsonString: string,
): SafeParseResult<ApiServiceIdAuthTokenCreate, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiServiceIdAuthTokenCreate$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiServiceIdAuthTokenCreate' from JSON`,
  );
}
