...
import {
  ...
  ClientAuthenticationMethod$outboundSchema,
} from "./clientauthenticationmethod.js";
import {
...
import {
  ...
  ItemsClientRegistrationTypes$outboundSchema,
} from "./itemsclientregistrationtypes.js";
import {
  ItemsFapiModes,
  ItemsFapiModes$inboundSchema,
  ItemsFapiModes$outboundSchema,
} from "./itemsfapimodes.js";
import {
  JwsAlg,
 ...
 * @remarks
 */
export const VerifiedClaimsValidationSchemaSet = {
  Standard: "standard",
 ...
 * @remarks
 */
export type VerifiedClaimsValidationSchemaSet = ClosedEnum<
  typeof VerifiedClaimsValidationSchemaSet
>;
 ...
 */
export const SupportedAttachment = {
  Embedded: "EMBEDDED",
  External: "EXTERNAL",
} as const;
/**
 ...
 *  for Identity Assurance 1.0.
 */
export type SupportedAttachment = ClosedEnum<typeof SupportedAttachment>;
...
export type Service = {
   ...
   * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
   */
  supportedTokenAuthMethods?: Array<ClientAuthenticationMethod> | undefined;
  /**
  ...
  supportedRevocationAuthMethods?:
    | Array<ClientAuthenticationMethod>
    | undefined;
  /**
   ...
   */
  supportedAttachments?: Array<SupportedAttachment> | undefined;
  /**
  ...
  supportedClientRegistrationTypes?:
    | Array<ItemsClientRegistrationTypes>
    | undefined;
  /**
   ...
   */
  fapiModes?: Array<ItemsFapiModes> | undefined;
  /**
...
/** @internal */
export const VerifiedClaimsValidationSchemaSet$inboundSchema: z.ZodNativeEnum<
  typeof VerifiedClaimsValidationSchemaSet
> = z.nativeEnum(VerifiedClaimsValidationSchemaSet);

/** @internal */
export const VerifiedClaimsValidationSchemaSet$outboundSchema: z.ZodNativeEnum<
  typeof VerifiedClaimsValidationSchemaSet
> = VerifiedClaimsValidationSchemaSet$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace VerifiedClaimsValidationSchemaSet$ {
  /** @deprecated use `VerifiedClaimsValidationSchemaSet$inboundSchema` instead. */
  export const inboundSchema = VerifiedClaimsValidationSchemaSet$inboundSchema;
  /** @deprecated use `VerifiedClaimsValidationSchemaSet$outboundSchema` instead. */
  export const outboundSchema =
    VerifiedClaimsValidationSchemaSet$outboundSchema;
}

/** @internal */
export const SupportedAttachment$inboundSchema: z.ZodNativeEnum<
  typeof SupportedAttachment
> = z.nativeEnum(SupportedAttachment);

/** @internal */
export const SupportedAttachment$outboundSchema: z.ZodNativeEnum<
  typeof SupportedAttachment
> = SupportedAttachment$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace SupportedAttachment$ {
  /** @deprecated use `SupportedAttachment$inboundSchema` instead. */
  export const inboundSchema = SupportedAttachment$inboundSchema;
  /** @deprecated use `SupportedAttachment$outboundSchema` instead. */
  export const outboundSchema = SupportedAttachment$outboundSchema;
}
...
export const Service$inboundSchema: z.ZodType<Service, z.ZodTypeDef, unknown> =
  z.object({
    ...
    supportedTokenAuthMethods: z.array(ClientAuthenticationMethod$inboundSchema)
      .optional(),
    ...
    verifiedClaimsValidationSchemaSet:
      VerifiedClaimsValidationSchemaSet$inboundSchema.optional(),
    ...
    supportedAttachments: z.array(SupportedAttachment$inboundSchema).optional(),
    ...
    trustAnchors: z.array(z.lazy(() => TrustAnchor$inboundSchema)).optional(),
    ...
    fapiModes: z.array(ItemsFapiModes$inboundSchema).optional(),
...
> = z.object({
  ...
  tokenEndpoint: z.string().optional(),
  directTokenEndpointEnabled: z.boolean().optional(),
  supportedTokenAuthMethods: z.array(ClientAuthenticationMethod$outboundSchema)
    .optional(),
  missingClientIdAllowed: z.boolean().optional(),
  revocationEndpoint: z.string().optional(),
  directRevocationEndpointEnabled: z.boolean().optional(),
  ...
  supportedVerifiedClaims: z.array(z.string()).optional(),
  verifiedClaimsValidationSchemaSet:
    VerifiedClaimsValidationSchemaSet$outboundSchema.optional(),
  ...
  refreshTokenIdempotent: z.boolean().optional(),
  signedJwksUri: z.string().optional(),
  supportedAttachments: z.array(SupportedAttachment$outboundSchema).optional(),
  supportedDigestAlgorithms: z.array(z.string()).optional(),
  supportedDocuments: z.array(z.string()).optional(),
  supportedDocumentsMethods: z.array(z.string()).optional(),
  supportedDocumentsValidationMethods: z.array(z.string()).optional(),
  ...
  jwtGrantUnsignedJwtRejected: z.boolean().optional(),
  dcrDuplicateSoftwareIdBlocked: z.boolean().optional(),
  trustAnchors: z.array(z.lazy(() => TrustAnchor$outboundSchema)).optional(),
  openidDroppedOnRefreshWithoutOfflineAccess: z.boolean().optional(),
  supportedDocumentsCheckMethods: z.array(z.string()).optional(),
  rsResponseSigned: z.boolean().optional(),
  cnonceDuration: z.number().int().optional(),
  ...
  idTokenReissuable: z.boolean().optional(),
  credentialJwks: z.string().optional(),
  fapiModes: z.array(ItemsFapiModes$outboundSchema).optional(),
  credentialDuration: z.number().int().optional(),
