...
import { introspectionEndpointAuthIntrospectionApi } from "../funcs/introspectionEndpointAuthIntrospectionApi.js";
import { introspectionEndpointAuthIntrospectionApiForm } from "../funcs/introspectionEndpointAuthIntrospectionApiForm.js";
import { introspectionEndpointAuthIntrospectionStandardApi } from "../funcs/introspectionEndpointAuthIntrospectionStandardApi.js";
import { introspectionEndpointAuthIntrospectionStandardApiForm } from "../funcs/introspectionEndpointAuthIntrospectionStandardApiForm.js";
...
export class IntrospectionEndpoint extends ClientSDK {
   ...
   * </details>
   */
  async authIntrospectionApiForm(
    request: operations.AuthIntrospectionApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.AuthIntrospectionApiFormResponse> {
    return unwrapAsync(introspectionEndpointAuthIntrospectionApiForm(
      this,
      request,
      options,
    ));
   ...
   * </details>
   */
  async authIntrospectionStandardApiForm(
    request: operations.AuthIntrospectionStandardApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.AuthIntrospectionStandardApiFormResponse> {
    return unwrapAsync(introspectionEndpointAuthIntrospectionStandardApiForm(
      this,
      request,
      options,
    ));
