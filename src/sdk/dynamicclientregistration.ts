...
import { dynamicClientRegistrationClientRegistrationApi } from "../funcs/dynamicClientRegistrationClientRegistrationApi.js";
import { dynamicClientRegistrationClientRegistrationApiForm } from "../funcs/dynamicClientRegistrationClientRegistrationApiForm.js";
import { dynamicClientRegistrationClientRegistrationDeleteApi } from "../funcs/dynamicClientRegistrationClientRegistrationDeleteApi.js";
import { dynamicClientRegistrationClientRegistrationDeleteApiForm } from "../funcs/dynamicClientRegistrationClientRegistrationDeleteApiForm.js";
import { dynamicClientRegistrationClientRegistrationGetApi } from "../funcs/dynamicClientRegistrationClientRegistrationGetApi.js";
import { dynamicClientRegistrationClientRegistrationUpdateApi } from "../funcs/dynamicClientRegistrationClientRegistrationUpdateApi.js";
import { dynamicClientRegistrationClientRegistrationUpdateApiForm } from "../funcs/dynamicClientRegistrationClientRegistrationUpdateApiForm.js";
...
export class DynamicClientRegistration extends ClientSDK {
   ...
   * </details>
   */
  async clientRegistrationApiForm(
    request: operations.ClientRegistrationApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.ClientRegistrationApiFormResponse> {
    return unwrapAsync(dynamicClientRegistrationClientRegistrationApiForm(
      this,
      request,
      options,
    ));
   ...
   * </details>
   */
  async clientRegistrationDeleteApiForm(
    request: operations.ClientRegistrationDeleteApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.ClientRegistrationDeleteApiFormResponse> {
    return unwrapAsync(dynamicClientRegistrationClientRegistrationDeleteApiForm(
      this,
      request,
      options,
    ));
