...
import { clientManagementClientAuthorizationUpdateApiForm } from "../funcs/clientManagementClientAuthorizationUpdateApiForm.js";
...
import { clientManagementClientFlagUpdateApiForm } from "../funcs/clientManagementClientFlagUpdateApiForm.js";
...
import { clientManagementClientSecretUpdateApiForm } from "../funcs/clientManagementClientSecretUpdateApiForm.js";
...
export class ClientManagement extends ClientSDK {
   ...
   * Lock and unlock a client
   */
  async clientFlagUpdateApiForm(
    request: operations.ClientFlagUpdateApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.ClientFlagUpdateApiFormResponse> {
    return unwrapAsync(clientManagementClientFlagUpdateApiForm(
      this,
      request,
      options,
    ));
  ...
  async clientAuthorizationDeleteApi(
    ...
    models.APILBraceserviceIdRBraceClientGrantedScopesLBraceclientIdRBrace200
  > {
