...
import { tokenEndpointAuthTokenApi } from "../funcs/tokenEndpointAuthTokenApi.js";
import { tokenEndpointAuthTokenApiForm } from "../funcs/tokenEndpointAuthTokenApiForm.js";
import { tokenEndpointAuthTokenFailApi } from "../funcs/tokenEndpointAuthTokenFailApi.js";
import { tokenEndpointAuthTokenFailApiForm } from "../funcs/tokenEndpointAuthTokenFailApiForm.js";
import { tokenEndpointAuthTokenIssueApi } from "../funcs/tokenEndpointAuthTokenIssueApi.js";
import { tokenEndpointAuthTokenIssueApiForm } from "../funcs/tokenEndpointAuthTokenIssueApiForm.js";
import { tokenEndpointIdtokenReissueApi } from "../funcs/tokenEndpointIdtokenReissueApi.js";
...
export class TokenEndpoint extends ClientSDK {
  ...
  async authTokenApi(
    ...
    return unwrapAsync(tokenEndpointAuthTokenApi(
      this,
      request,
      options,
    ));
   ...
   * </details>
   */
  async authTokenApiForm(
    request: operations.AuthTokenApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.AuthTokenApiFormResponse> {
    return unwrapAsync(tokenEndpointAuthTokenApiForm(
      this,
      request,
      options,
    ));
