...
import { federationEndpointFederationRegistrationApiForm } from "../funcs/federationEndpointFederationRegistrationApiForm.js";
...
export class FederationEndpoint extends ClientSDK {
   ...
   * </p>
   */
  async federationRegistrationApiForm(
    request: operations.FederationRegistrationApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.FederationRegistrationApiFormResponse> {
    return unwrapAsync(federationEndpointFederationRegistrationApiForm(
      this,
      request,
      options,
    ));
