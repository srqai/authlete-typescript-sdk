...
import { revocationEndpointAuthRevocationApi } from "../funcs/revocationEndpointAuthRevocationApi.js";
import { revocationEndpointAuthRevocationApiForm } from "../funcs/revocationEndpointAuthRevocationApiForm.js";
import { ClientSDK, RequestOptions } from "../lib/sdks.js";
import * as operations from "../models/operations/index.js";
import { unwrapAsync } from "../types/fp.js";

export class RevocationEndpoint extends ClientSDK {
  /**
   ...
   * </details>
   */
  async authRevocationApiForm(
    request: operations.AuthRevocationApiFormRequest,
    options?: RequestOptions,
  ): Promise<operations.AuthRevocationApiFormResponse> {
    return unwrapAsync(revocationEndpointAuthRevocationApiForm(
      this,
      request,
      options,
    ));
