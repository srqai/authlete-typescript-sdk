 ...
 * </details>
 */
export function tokenEndpointAuthTokenFailApi(
  client: AuthleteCore,
  request: operations.AuthTokenFailApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenFailApiResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AuthTokenFailApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthTokenFailApiResponse$inboundSchema),
