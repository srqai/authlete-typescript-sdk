 ...
 * </details>
 */
export function dynamicClientRegistrationClientRegistrationGetApi(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ClientRegistrationGetApiRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ClientRegistrationRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/{serviceId}/client/registration/get")(
    pathParams,
  );
