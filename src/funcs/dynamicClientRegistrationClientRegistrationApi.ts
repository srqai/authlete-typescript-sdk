 ...
 * </details>
 */
export function dynamicClientRegistrationClientRegistrationApi(
  client: AuthleteCore,
  request: operations.ClientRegistrationApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ClientRegistrationApiResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ClientRegistrationApiResponse$inboundSchema),
