 ...
 * Create Security Key
 */
export function hardwareSecurityKeyHskCreateApi(
  client: AuthleteCore,
  request: operations.HskCreateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HskCreateApiResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HskCreateApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HskCreateApiResponse$inboundSchema),
