 ...
 * </details>
 */
export function introspectionEndpointAuthIntrospectionStandardApiForm(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthIntrospectionStandardApiFormRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "auth_introspection_standard_api_form",
    oAuth2Scopes: [],
