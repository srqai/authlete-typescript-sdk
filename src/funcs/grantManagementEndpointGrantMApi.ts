 ...
 */
export function grantManagementEndpointGrantMApi(
  client: AuthleteCore,
  request: operations.GrantMApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GrantMApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GrantMApiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/{serviceId}/gm")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GrantMApiResponse$inboundSchema),
