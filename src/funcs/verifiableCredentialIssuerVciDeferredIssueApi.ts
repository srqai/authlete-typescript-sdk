 ...
 */
export function verifiableCredentialIssuerVciDeferredIssueApi(
  client: AuthleteCore,
  request: operations.VciDeferredIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.VciDeferredIssueApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.VciDeferredIssueApiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/{serviceId}/vci/deferred/issue")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VciDeferredIssueApiResponse$inboundSchema),
