 ...
 * </details>
 */
export function federationEndpointFederationConfigurationApi(
  client: AuthleteCore,
  request: operations.FederationConfigurationApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.FederationConfigurationApiResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FederationConfigurationApiResponse$inboundSchema),
