 ...
 * </details>
 */
export function authorizationEndpointAuthAuthorizationFailApi(
  client: AuthleteCore,
  request: operations.AuthAuthorizationFailApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthAuthorizationFailApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthAuthorizationFailApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthAuthorizationFailApiResponse$inboundSchema),
