 ...
 */
export function serviceManagementServiceGetApi(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ServiceGetApiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/{serviceId}/service/get")(pathParams);
