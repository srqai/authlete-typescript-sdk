 ...
 * - ViewClient: []
 */
export function clientManagementClientGetListApi(
  client: AuthleteCore,
  request: operations.ClientGetListApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ClientGetListApiResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ClientGetListApiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/{serviceId}/client/get/list")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ClientGetListApiResponse$inboundSchema),
