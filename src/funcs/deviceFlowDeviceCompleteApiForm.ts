...
export function deviceFlowDeviceCompleteApiForm(
  ...
  Result<
    operations.DeviceCompleteApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeviceCompleteApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_device_complete || {}).map(
    ([k, v]) => {
  ...
  const context = {
    ...
    operationID: "device_complete_api_form",
    oAuth2Scopes: [],
