 ...
 */
export function tokenOperationsAuthTokenDeleteApi(
  client: AuthleteCore,
  request: operations.AuthTokenDeleteApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenDeleteApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AuthTokenDeleteApiRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    accessTokenIdentifier: encodeSimple(
      "accessTokenIdentifier",
      payload.accessTokenIdentifier,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(204, operations.AuthTokenDeleteApiResponse$inboundSchema),
