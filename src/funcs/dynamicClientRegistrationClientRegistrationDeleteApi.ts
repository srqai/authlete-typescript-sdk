 ...
 * </details>
 */
export function dynamicClientRegistrationClientRegistrationDeleteApi(
  client: AuthleteCore,
  request: operations.ClientRegistrationDeleteApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ClientRegistrationDeleteApiResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ClientRegistrationDeleteApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ClientRegistrationDeleteApiResponse$inboundSchema),
