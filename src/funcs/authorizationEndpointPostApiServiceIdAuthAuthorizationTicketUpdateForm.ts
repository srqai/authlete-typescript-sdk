 ...
 */
export function authorizationEndpointPostApiServiceIdAuthAuthorizationTicketUpdateForm(
  client: AuthleteCore,
  request: operations.PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest,
...
> {
  ...
  const body = Object.entries(payload.AuthorizationTicketUpdate || {}).map(
    ([k, v]) => {
  ...
  const context = {
    ...
    operationID: "post_/api/{serviceId}/auth/authorization/ticket/update_form",
    oAuth2Scopes: [],
