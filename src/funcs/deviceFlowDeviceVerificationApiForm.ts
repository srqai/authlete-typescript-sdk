 ...
 * </details>
 */
export function deviceFlowDeviceVerificationApiForm(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeviceVerificationApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_device_verification || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "device_verification_api_form",
    oAuth2Scopes: [],
