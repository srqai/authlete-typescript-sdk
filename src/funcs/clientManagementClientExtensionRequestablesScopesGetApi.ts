 ...
 */
export function clientManagementClientExtensionRequestablesScopesGetApi(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ClientExtensionRequestablesScopesGetApiRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.ClientExtensionRequestablesScopesGetApiResponse$inboundSchema,
    ),
