 ...
 */
export function tokenOperationsAuthTokenRevokeApiForm(
  client: AuthleteCore,
  request: operations.AuthTokenRevokeApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenRevokeApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthTokenRevokeApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_auth_token_revoke || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_token_revoke_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthTokenRevokeApiFormResponse$inboundSchema),
