 ...
 * </details>
 */
export function authorizationEndpointAuthAuthorizationApiForm(
  client: AuthleteCore,
  request: operations.AuthAuthorizationApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthAuthorizationApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthAuthorizationApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_auth_authorization || {})
    .map(([k, v]) => {
  ...
  const path = pathToFunc("/api/{serviceId}/auth/authorization")(pathParams);
  ...
  const context = {
    ...
    operationID: "auth_authorization_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthAuthorizationApiFormResponse$inboundSchema),
