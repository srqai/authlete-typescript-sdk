 ...
 */
export function authorizationEndpointGetApiServiceIdAuthAuthorizationTicketInfo(
  client: AuthleteCore,
  request: operations.GetApiServiceIdAuthAuthorizationTicketInfoRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiServiceIdAuthAuthorizationTicketInfoResponse,
    | AuthleteError
...
> {
  ...
  const path = pathToFunc("/api/{serviceId}/auth/authorization/ticket/info")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "get_/api/{serviceId}/auth/authorization/ticket/info",
    oAuth2Scopes: [],
