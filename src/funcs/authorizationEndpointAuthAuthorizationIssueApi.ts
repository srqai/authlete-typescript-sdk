 ...
 * </details>
 */
export function authorizationEndpointAuthAuthorizationIssueApi(
  client: AuthleteCore,
  request: operations.AuthAuthorizationIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthAuthorizationIssueApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthAuthorizationIssueApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthAuthorizationIssueApiResponse$inboundSchema),
