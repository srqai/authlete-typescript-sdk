 ...
 * </details>
 */
export function authorizationEndpointAuthAuthorizationApi(
  client: AuthleteCore,
  request: operations.AuthAuthorizationApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthAuthorizationApiResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthAuthorizationApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthAuthorizationApiResponse$inboundSchema),
