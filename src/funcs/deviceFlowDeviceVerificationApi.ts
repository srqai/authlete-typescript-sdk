 ...
 * </details>
 */
export function deviceFlowDeviceVerificationApi(
  client: AuthleteCore,
  request: operations.DeviceVerificationApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeviceVerificationApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeviceVerificationApiResponse$inboundSchema),
