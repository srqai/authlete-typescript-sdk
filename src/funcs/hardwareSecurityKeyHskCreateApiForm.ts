 ...
 * Create Security Key
 */
export function hardwareSecurityKeyHskCreateApiForm(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HskCreateApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.HskCreateRequest || {}).map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "hsk_create_api_form",
    oAuth2Scopes: [],
