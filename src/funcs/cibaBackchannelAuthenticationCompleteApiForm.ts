 ...
 * </details>
 */
export function cibaBackchannelAuthenticationCompleteApiForm(
  client: AuthleteCore,
  request: operations.BackchannelAuthenticationCompleteApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BackchannelAuthenticationCompleteApiFormResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BackchannelAuthenticationCompleteApiFormRequest$outboundSchema
        .parse(value),
  ...
  const body = Object.entries(
    payload.APILBraceserviceIdRBraceBackchannelAuthenticationComplete || {},
  ).map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "backchannel_authentication_complete_api_form",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.BackchannelAuthenticationCompleteApiFormResponse$inboundSchema,
    ),
