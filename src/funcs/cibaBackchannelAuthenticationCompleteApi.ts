 ...
 * </details>
 */
export function cibaBackchannelAuthenticationCompleteApi(
  client: AuthleteCore,
  request: operations.BackchannelAuthenticationCompleteApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BackchannelAuthenticationCompleteApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  ...
  >(
    M.json(
      200,
      operations.BackchannelAuthenticationCompleteApiResponse$inboundSchema,
    ),
