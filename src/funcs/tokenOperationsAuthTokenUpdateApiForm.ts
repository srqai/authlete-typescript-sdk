 ...
 */
export function tokenOperationsAuthTokenUpdateApiForm(
  client: AuthleteCore,
  request: operations.AuthTokenUpdateApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenUpdateApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthTokenUpdateApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_auth_token_update || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_token_update_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthTokenUpdateApiFormResponse$inboundSchema),
