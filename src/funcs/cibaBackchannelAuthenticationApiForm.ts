 ...
 * </details>
 */
export function cibaBackchannelAuthenticationApiForm(
  client: AuthleteCore,
  request: operations.BackchannelAuthenticationApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BackchannelAuthenticationApiFormResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BackchannelAuthenticationApiFormRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = Object.entries(payload.BackchannelAuthenticationRequest || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "backchannel_authentication_api_form",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.BackchannelAuthenticationApiFormResponse$inboundSchema,
    ),
