 ...
 * Delete Security Key
 */
export function hardwareSecurityKeyHskDeleteApi(
  client: AuthleteCore,
  request: operations.HskDeleteApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HskDeleteApiResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HskDeleteApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(204, operations.HskDeleteApiResponse$inboundSchema),
