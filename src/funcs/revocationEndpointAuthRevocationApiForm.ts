 ...
 * </details>
 */
export function revocationEndpointAuthRevocationApiForm(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthRevocationApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.RevocationRequest || {}).map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_revocation_api_form",
    oAuth2Scopes: [],
