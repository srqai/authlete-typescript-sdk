 ...
 * Get a client.
 */
export function clientManagementClientGetApi(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ClientGetApiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/{serviceId}/client/get/{clientId}")(pathParams);
