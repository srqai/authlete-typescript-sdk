 ...
 * </details>
 */
export function cibaBackchannelAuthenticationFailApiForm(
  client: AuthleteCore,
  request: operations.BackchannelAuthenticationFailApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BackchannelAuthenticationFailApiFormResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BackchannelAuthenticationFailApiFormRequest$outboundSchema
        .parse(value),
  ...
  const body = Object.entries(
    payload.APILBraceserviceIdRBraceBackchannelAuthenticationFail || {},
  ).map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "backchannel_authentication_fail_api_form",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.BackchannelAuthenticationFailApiFormResponse$inboundSchema,
    ),
