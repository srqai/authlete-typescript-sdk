 ...
 * null
 */
export function verifiableCredentialIssuerVciJwtissuerApiForm(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.VciJwtissuerApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.VciJwtIssuerRequest || {}).map(
    ([k, v]) => {
  ...
  const context = {
    ...
    operationID: "vci_jwtissuer_api_form",
    oAuth2Scopes: [],
