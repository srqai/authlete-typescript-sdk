 ...
 * </details>
 */
export function tokenEndpointAuthTokenIssueApi(
  client: AuthleteCore,
  request: operations.AuthTokenIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenIssueApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AuthTokenIssueApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthTokenIssueApiResponse$inboundSchema),
