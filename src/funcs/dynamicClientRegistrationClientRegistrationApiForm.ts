 ...
 * </details>
 */
export function dynamicClientRegistrationClientRegistrationApiForm(
  client: AuthleteCore,
  request: operations.ClientRegistrationApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ClientRegistrationApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ClientRegistrationApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_client_registration || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "client_registration_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ClientRegistrationApiFormResponse$inboundSchema),
