 ...
 * </details>
 */
export function introspectionEndpointAuthIntrospectionApiForm(
  client: AuthleteCore,
  request: operations.AuthIntrospectionApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthIntrospectionApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthIntrospectionApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_auth_introspection || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_introspection_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthIntrospectionApiFormResponse$inboundSchema),
