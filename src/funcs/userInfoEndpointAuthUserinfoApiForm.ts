 ...
 * </details>
 */
export function userInfoEndpointAuthUserinfoApiForm(
  client: AuthleteCore,
  request: operations.AuthUserinfoApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthUserinfoApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthUserinfoApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_auth_userinfo || {}).map(
    ([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_userinfo_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthUserinfoApiFormResponse$inboundSchema),
