 ...
 */
export function tokenOperationsAuthTokenCreateApiForm(
  client: AuthleteCore,
  request: operations.AuthTokenCreateApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenCreateApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthTokenCreateApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_auth_token_create || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_token_create_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthTokenCreateApiFormResponse$inboundSchema),
