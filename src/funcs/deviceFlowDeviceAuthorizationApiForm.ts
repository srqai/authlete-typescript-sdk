 ...
 * </details>
 */
export function deviceFlowDeviceAuthorizationApiForm(
  client: AuthleteCore,
  request: operations.DeviceAuthorizationApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeviceAuthorizationApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeviceAuthorizationApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_device_authorization || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "device_authorization_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeviceAuthorizationApiFormResponse$inboundSchema),
