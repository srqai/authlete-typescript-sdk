 ...
 * </details>
 */
export function cibaBackchannelAuthenticationIssueApiForm(
  client: AuthleteCore,
  request: operations.BackchannelAuthenticationIssueApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BackchannelAuthenticationIssueApiFormResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BackchannelAuthenticationIssueApiFormRequest$outboundSchema
        .parse(value),
  ...
  const body = Object.entries(
    payload.APILBraceserviceIdRBraceBackchannelAuthenticationIssue || {},
  ).map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "backchannel_authentication_issue_api_form",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.BackchannelAuthenticationIssueApiFormResponse$inboundSchema,
    ),
