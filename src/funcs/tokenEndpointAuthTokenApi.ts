 ...
 * </details>
 */
export function tokenEndpointAuthTokenApi(
  client: AuthleteCore,
  request: operations.AuthTokenApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AuthTokenApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AuthTokenApiRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AuthTokenApiResponse$inboundSchema),
