...
export function clientManagementClientDeleteApi(
  ...
  Result<
    operations.ClientDeleteApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ClientDeleteApiRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/{serviceId}/client/delete/{clientId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(204, operations.ClientDeleteApiResponse$inboundSchema),
