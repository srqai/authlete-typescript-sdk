 ...
 * </details>
 */
export function userInfoEndpointAuthUserinfoIssueApiForm(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthUserinfoIssueApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.UserinfoIssueRequest || {}).map(
    ([k, v]) => {
  ...
  const context = {
    ...
    operationID: "auth_userinfo_issue_api_form",
    oAuth2Scopes: [],
