 ...
 * </details>
 */
export function cibaBackchannelAuthenticationApi(
  client: AuthleteCore,
  request: operations.BackchannelAuthenticationApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BackchannelAuthenticationApiResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BackchannelAuthenticationApiResponse$inboundSchema),
