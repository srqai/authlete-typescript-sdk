 ...
 * </details>
 */
export function dynamicClientRegistrationClientRegistrationUpdateApiForm(
  client: AuthleteCore,
  request: operations.ClientRegistrationUpdateApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ClientRegistrationUpdateApiFormResponse,
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ClientRegistrationUpdateApiFormRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = Object.entries(payload.ClientRegistrationUpdateRequest || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "client_registration_update_api_form",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.ClientRegistrationUpdateApiFormResponse$inboundSchema,
    ),
