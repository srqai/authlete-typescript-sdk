 ...
 */
export function verifiableCredentialIssuerVciDeferredParseApiForm(
  client: AuthleteCore,
  request: operations.VciDeferredParseApiFormRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.VciDeferredParseApiFormResponse,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error500
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.VciDeferredParseApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload.api_serviceId_vci_deferred_parse || {})
    .map(([k, v]) => {
  ...
  const context = {
    ...
    operationID: "vci_deferred_parse_api_form",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VciDeferredParseApiFormResponse$inboundSchema),
