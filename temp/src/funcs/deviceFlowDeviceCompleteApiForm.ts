...
import { AuthleteCore } from "../core.js";import { encodeBodyForm, encodeSimple } from "../lib/encodings.js";
 ...
 * 
 */
export function deviceFlowDeviceCompleteApiForm(
  client: AuthleteCore,
  request: operations.DeviceCompleteApiFormRequest,
  options?: RequestOptions,
): APIPromise<Result<operations.DeviceCompleteApiFormResponse, errors.1api1infoGetResponses400Error | errors.1api1infoGetResponses400ContentApplication1jsonSchemaError | AuthleteError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>> {
...
async function $do(
  ...
  request: operations.DeviceCompleteApiFormRequest,
  options?: RequestOptions,
): Promise<[Result<operations.DeviceCompleteApiFormResponse, errors.1api1infoGetResponses400Error | errors.1api1infoGetResponses400ContentApplication1jsonSchemaError | AuthleteError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>, APICall]> {


  const parsed = safeParse(
    request,
    (value) => operations.DeviceCompleteApiFormRequest$outboundSchema.parse(value),
  ...
  const body = Object.entries(payload["~1api~1{serviceId}~1device~1complete/post/requestBody/content/application~1json/schema"] || {}).map(([k, v]) => {
    return encodeBodyForm(k, v, { charEncoding: "percent" });
  }).join("&");
  
  const pathParams = {
    serviceId: encodeSimple("serviceId", payload.serviceId, { explode: false, charEncoding: "percent" }),
  };
  ...
  const context = {
    ...
    baseURL: options?.serverURL ?? client._baseURL ?? "",operationID: "device_complete_api_form",
    oAuth2Scopes: [],
  ...
  const requestRes = client._createRequest(context, {security: requestSecurity,method: "POST",
    baseURL: options?.serverURL,path: path,
    headers: headers,body: body,userAgent: client._options.userAgent,
  ...
  const [result] = await M.match<operations.DeviceCompleteApiFormResponse, errors.1api1infoGetResponses400Error | errors.1api1infoGetResponses400ContentApplication1jsonSchemaError | AuthleteError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>(
  M.json(200, operations.DeviceCompleteApiFormResponse$inboundSchema, ),
  M.jsonErr(400, errors.1api1infoGetResponses400Error$inboundSchema, ),
  M.jsonErr([401, 403], errors.1api1infoGetResponses400ContentApplication1jsonSchemaError$inboundSchema, ),
  M.jsonErr(500, errors.1api1infoGetResponses400ContentApplication1jsonSchemaError$inboundSchema, ),
  M.fail("4XX"),
